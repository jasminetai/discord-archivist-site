  ...
  return (
    <>
      <article>
        <h1>About</h1>
        <p>
          Archivist is a Discord bot equipped with commands for{' '}
          <a href="https://bandit.rip">Super Bandit RIP</a>. It features:
        </p>
        <ul>
        ...
        <p>
          Try Archivist out in the official{' '}
      ...
      <article>
        ...
        <p>
          ...
          would include switching prefix-based commands to slash commands and securing more
          resources for the bot.
        </p>
        <p>
          Unfortunately, this limits the number of servers Archivist can join. Consequently, we tend
          to deny requests for adding it to inactive servers or servers unrelated to Super Bandit
          RIP.
        </p>
        <p>
